...
def main(link, matcht, infor, matchdata, update, fmt):
	print(link, matcht)
	leagueLink = link
	...
	years = soup.findAll(class_="QuoteSummary", href=True)
	...
	for y in years:
		if(int(y.text) > 2020):
		# if("ci/engine/records/team/match_results.html?class=;" in y['href']) and int(y.text.split("/")[0]) > 2020:
			# print(y.text)
	...
	return convertoxl.main(infoRows, matchTracker, fmt)
